...
class APIfeatures {
    ...
    filtering() {
        ...
        if (queryObj.categoria !== "all") this.query.find({
            categoria: queryObj.categoria
        });
...
const getBlogs = async (req, res)=>{
    try {
        const features = new APIfeatures(_models_Blog__WEBPACK_IMPORTED_MODULE_0__/* ["default"].find */ .Z.find(), req.query).filtering().sorting().paginating();
...
const createBlog = async (req, res)=>{
    try {
        ...
        const newBlog = new _models_Blog__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z({
            titulo,
            resumo,
            texto,
            categoria,
...
var __webpack_exports__ = __webpack_require__.X(0, [920], () => (__webpack_exec__(8135)));
