    ...
    return (
      <Flex direction={'column'}>
        <Layout>
          ...
          <Flex direction='column' w={'full'} px={['20px', '20px', '20px' , '60px' , '60px']} justifyContent={'space-between'}>
          ...
          <Flex direction='column' w={'full'} px={['20px', '20px', '20px' , '60px' , '60px']} mt={9} justifyContent={'space-between'}>
            <FormVisitante />
          </Flex>
        </Layout>
      </Flex>
